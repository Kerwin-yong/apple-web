// --- 视频资源 (路径直接指向 public 里的 assets) ---
export const heroVideo = "/assets/videos/hero.mp4"; 
export const highlightFirstVideo = "/assets/videos/hightlight-first.mp4";
...
export const highlightForthVideo = "/assets/videos/hightlight-forth.mp4";
